...
impl<T> Serialize for crate::metadata::polkadot_staging_primitives::CandidateDescriptorV2<T>
where
...
impl<T> Serialize for crate::metadata::polkadot_staging_primitives::CandidateReceiptV2<T>
where
	T: Hash + Serialize + Decode + Encode,
{
	fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
